...
ALTER TABLE IF EXISTS cultos ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS pauta_itens ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS pauta_marcacoes ENABLE ROW LEVEL SECURITY;
