...
export const PERMISSOES_DISPONIVEIS = [
  ...
  { key: 'registros_ver',       label: 'Completude — Ver',        descricao: 'Ver quais membros estão sem data de nascimento ou casamento' },
  { key: 'registros_editar',    label: 'Completude — Editar',     descricao: 'Preencher datas de nascimento e casamento direto na lista' },
